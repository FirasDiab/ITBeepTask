                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body m-4">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="goToPeriod" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="serviceData()">
                                        Next
                                    </button>
                                </div>
                            ...
                            <div class="modal fade" id="periodModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="periodModalLabel">Modal title</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body m-3">

                                                @foreach($periods as $period)
                                                    <button type="button" class="btn btn-primary m-4" id="{{ $period->period_time }}" value="0" onclick="selectPeriod(this.id)">{{$period->period_time}}</button>
                                            @endforeach
                                        </div>
                                        <input id="period" type="hidden" name="period" />
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
...
<script>
    function selectPeriod(id){
        let period1 = document.getElementById("general").value;
        let period2 = document.getElementById("one_week").value;
        let period3 = document.getElementById("one_month").value;

        if ( id == 'general' && period1 == 0) {
            document.getElementById("period").value = 'General';
